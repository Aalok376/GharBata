...
export default function OtherClientProfile() {
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden backdrop-blur-sm border border-white/20">
          ...
          <div className="p-6 bg-gradient-to-br from-slate-50 to-gray-50 space-y-3">
            {/* Message Button */}
            <button className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white py-4 px-6 rounded-xl hover:from-emerald-600 hover:to-teal-600 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl font-semibold">
