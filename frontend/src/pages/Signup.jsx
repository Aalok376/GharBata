    ...
    <div className='bg-white p-8 rounded shadow-lg w-full max-w-md border-gray-200'>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <div>
                ...
                id="name"
                name="name"
                className='w-full p-2 border rounded text-bold'
            ...
            <div>
                <label htmlFor='phoneNumber' className='block mb-1 text-gray-600'>Phone Number</label>
                <input
                type="text"
                id="phoneNumber"
                name="phoneNumber"
...
export default Signup; // export the component for use in other files