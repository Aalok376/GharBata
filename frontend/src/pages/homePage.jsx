...
{/*
// Updated React Component Using Tailwind CSS
import React, { useState, useEffect } from "react";
import StyledLinkFunc from "../components/syledLink";
import Navbar from "../components/Navbar";
import ServiceCard from "../components/serviceCard";
...
const HomePageFunc = () => {
  ...
  return (
    <div className="font-sans text-gray-900 overflow-x-hidden">
      ...
      <section className=" bg-gradient-to-br from-indigo-500 to-purple-600 text-white pt-[100px] pb-32  overflow-hidden ">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center ">
          <div>
            ...
            <p className="text-xl opacity-90 mb-8 ">
              From cleaning and repairs to maintenance and installations - get
              trusted professionals to handle all your home needs with just a
              few clicks.
            </p>
            <div className="flex gap-4 ">
              <StyledLinkFunc dynamicId="#services" text="View Services" />
            </div>
          </div>
          <div className="flex justify-center ">
            <div className="bg-white bg-opacity-10 backdrop-blur-lg border border-white border-opacity-20  rounded-2xl p-8 w-full max-w-sm shadow-lg">
              <h3 className="text-lg font-semibold text-white leading-snug mb-4">
                🏠 Book Your Service
              </h3>
              <p className="mb-2">• Same-day availability</p>
              <p className="mb-2">• Verified professionals</p>
              <p className="mb-2">• 100% satisfaction guarantee</p>
              <p className="mb-2">• Transparent pricing</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500 max-w-2xl mx-auto">
              Professional home services delivered by verified experts in your
              area
            </p>
          </div>
          <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            ...
            <ServiceCard
              icon="🔧"
              header="Home Repairs"
              description="Plumbing, electrical, carpentry, and general home repair services"
              services={Service2}
            />
            <ServiceCard
              icon="🌿"
              header="Garden & Lawn Care"
              description="Landscaping, lawn maintenance, and garden care services"
              services={Service3}
            />
            <ServiceCard
              icon="📱"
              header="Tech Installation"
              description="Smart home setup, TV mounting, and tech support services"
              services={Service4}
            />
            <ServiceCard
              icon="🏠"
              header="Home Maintenance"
              description="Regular upkeep, inspections, and preventive maintenance"
              services={Service5}
            />
            <ServiceCard
              icon="📦"
              header="Moving & Assembly"
              description="Furniture assembly, moving assistance, and organization"
              services={Service6}
            />
          </div>
        </div>
      ...
      <section id="#how-it-works" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500 max-w-2xl mx-auto">
              Get your home services booked and completed in just a few simple
              steps
            </p>
          </div>
          <div className="grid gap-12 grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
            <Steps
              stepsnumber="1"
              title="Choose Your Service"
              description="Select from our wide range of professional home services and specify your requirements"
            />
            <Steps
              stepsnumber="2"
              title="Schedule & Book"
              description="Pick your preferred date and time, and book your service with verified professionals"
            />
            <Steps
              stepsnumber="3"
              title="Professional Arrives"
              description="Our vetted professional arrives on time with all necessary tools and equipment"
            />
            <Steps
              stepsnumber="4"
              title="Service Completed"
              description="Enjoy your completed service with our satisfaction guarantee and easy payment"
            />
          </div>
        </div>
      </section>

      <section className="bg-gradient-to-r from-gray-50 to-blue-100 py-20">
        <div className="max-w-7xl mx-auto px-4">
          <StyledLinkFunc
            dynamicId="#book"
            text="Book Service Now"
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
          <div>
            <h3 className="text-lg font-semibold mb-4">HomeServe</h3>
            <p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <Link to="#">Home Repairs</Link>
              </li>
              <li>
                <Link to="#">Garden Care</Link>
              </li>
              <li>
                <Link to="#">Tech Installation</Link>
              </li>
            </ul>
          </div>
          <div>
