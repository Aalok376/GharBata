...
const TermsAndCondition = () => {
  return (
    <>
      ...
      <div className="overlay" id="termsOverlay" onClick={"hideTerms(event)"}>
        <div className="terms-container" onClick={"event.stopPropagation()"}>
          <div className="terms-header">
            <button className="close-btn" onClick={"hideTerms()"}>&times;</button>
